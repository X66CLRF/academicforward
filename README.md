...
| 📈 **Automation** | [Automation/kpi-report.md](Automation/kpi-report.md) | `v1.0` | 📈 **กษิดิศ (คนเดียว)** — ขั้นปิดงานสกิลออกแบบ: ส่งไฟล์ไฟนอลเข้า `G:\My Drive\อบรม` + บันทึกผลงานเข้า KPI aritc-audit ผ่าน `scripts/kpi-report.mjs` | [📖 เปิดไฟล์](Automation/kpi-report.md) |
