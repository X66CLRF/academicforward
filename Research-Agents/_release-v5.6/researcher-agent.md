...
> ⚡ **เขียนตำราฉบับเต็มจริงจัง (ทีละหัวข้อย่อย, ระบบภาพ, Bibliography_Log, บัตรสถานะ) → ใช้ `textbook-agent.md` แทนโหมดนี้** — โหมดในไฟล์นี้เหมาะกับงานร่างโครง/เอกสารประกอบการสอนขนาดเล็กเท่านั้น
